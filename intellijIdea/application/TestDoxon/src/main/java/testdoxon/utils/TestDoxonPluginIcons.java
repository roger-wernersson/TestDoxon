...
public interface TestDoxonPluginIcons {
    Icon LOGO = IconLoader.getIcon("/icons/testDox16px.png");
    ...
    Icon SORT_DISABLED = IconLoader.getIcon("/icons/sortDisabled.png");
    ...
    Icon greenDot = IconLoader.getIcon("/icons/testDox-green8px.png");
    Icon yellowDot = IconLoader.getIcon("/icons/testDox-yellow8px.png");
}
